...
Above definition will encode this CMP instruction "cmp $sw, $2, $3" into 
"10f23000".

RetLR (Cpu0ISD::Ret) and JR (ISD::BRIND) are both for "ret" instruction. 
...
exit point. Details is explained in Chapter 3 here [#]_.
