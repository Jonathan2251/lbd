...
porting to new llvm version, please do the following before generate documents.
...
The Cpu0 regression test items copied from Mips. 
...
These test items of supported and not supported are in 
