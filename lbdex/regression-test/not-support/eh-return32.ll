...
; CHECK:        st      $6, [[offset2:[0-9]+|t9]]($sp)
; CHECK:        st      $7, [[offset3:[0-9]+|t9]]($sp)
...
; check that $a0-$a3 are saved on stack.
; CHECK:        sw      $4, [[offset0:[0-9]+|t9]]($sp)
; CHECK:        sw      $5, [[offset1:[0-9]+|t9]]($sp)
; CHECK:        sw      $6, [[offset2:[0-9]+|t9]]($sp)
; CHECK:        sw      $7, [[offset3:[0-9]+|t9]]($sp)
