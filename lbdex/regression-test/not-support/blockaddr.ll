...
; PIC-O32: lw  $[[R0:[0-9]+|t9]], %got($tmp[[T0:[0-9]+|t9]])
; PIC-O32: addiu ${{[0-9]+|t9}}, $[[R0]], %lo($tmp[[T0]])
; PIC-O32: lw  $[[R1:[0-9]+|t9]], %got($tmp[[T1:[0-9]+|t9]])
; PIC-O32: addiu ${{[0-9]+|t9}}, $[[R1]], %lo($tmp[[T1]])
; STATIC-O32: lui  $[[R2:[0-9]+|t9]], %hi($tmp[[T2:[0-9]+|t9]])
; STATIC-O32: addiu ${{[0-9]+|t9}}, $[[R2]], %lo($tmp[[T2]])
; STATIC-O32: lui   $[[R3:[0-9]+|t9]], %hi($tmp[[T3:[0-9]+|t9]])
; STATIC-O32: addiu ${{[0-9]+|t9}}, $[[R3]], %lo($tmp[[T3]])
; PIC-N32: lw  $[[R0:[0-9]+|t9]], %got_page($tmp[[T0:[0-9]+|t9]])
; PIC-N32: addiu ${{[0-9]+|t9}}, $[[R0]], %got_ofst($tmp[[T0]])
; PIC-N32: lw  $[[R1:[0-9]+|t9]], %got_page($tmp[[T1:[0-9]+|t9]])
; PIC-N32: addiu ${{[0-9]+|t9}}, $[[R1]], %got_ofst($tmp[[T1]])
; STATIC-N32: lui  $[[R2:[0-9]+|t9]], %hi($tmp[[T2:[0-9]+|t9]])
; STATIC-N32: addiu ${{[0-9]+|t9}}, $[[R2]], %lo($tmp[[T2]])
; STATIC-N32: lui   $[[R3:[0-9]+|t9]], %hi($tmp[[T3:[0-9]+|t9]])
; STATIC-N32: addiu ${{[0-9]+|t9}}, $[[R3]], %lo($tmp[[T3]])
; PIC-N64: ld  $[[R0:[0-9]+|t9]], %got_page($tmp[[T0:[0-9]+|t9]])
; PIC-N64: daddiu ${{[0-9]+|t9}}, $[[R0]], %got_ofst($tmp[[T0]])
; PIC-N64: ld  $[[R1:[0-9]+|t9]], %got_page($tmp[[T1:[0-9]+|t9]])
; PIC-N64: daddiu ${{[0-9]+|t9}}, $[[R1]], %got_ofst($tmp[[T1]])
; STATIC-N64: ld  $[[R2:[0-9]+|t9]], %got_page($tmp[[T2:[0-9]+|t9]])
; STATIC-N64: daddiu ${{[0-9]+|t9}}, $[[R2]], %got_ofst($tmp[[T2]])
; STATIC-N64: ld  $[[R3:[0-9]+|t9]], %got_page($tmp[[T3:[0-9]+|t9]])
; STATIC-N64: daddiu ${{[0-9]+|t9}}, $[[R3]], %got_ofst($tmp[[T3]])
